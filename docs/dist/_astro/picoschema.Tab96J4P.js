const e="reference/picoschema.mdx",n="docs",t="reference/picoschema",a=`
Picoschema is a compact, YAML-optimized schema definition format specifically designed to aid in describing structured data for better understanding by GenAI models. Whenever a schema is accepted by Prompt in its Frontmatter, the Picoschema format is accepted.
...
These error checks ensure that the Picoschema is well-formed and can be correctly translated to JSON Schema.`,i={title:"Picoschema",author:"Firebase",sort_order:2,draft:!1,tags:[],hide_breadcrumbs:!1,hide_toc:!1,hide_sidenav:!1,max_width:!1},s={type:"content",filePath:"/workspaces/.prompt/docs/src/content/docs/reference/picoschema.mdx",rawData:void 0};export{s as _internal,a as body,n as collection,i as data,e as id,t as slug};
