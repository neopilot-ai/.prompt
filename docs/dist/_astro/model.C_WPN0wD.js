const e="reference/model.mdx",n="docs",t="reference/model",o=`
Prompt implementations are not required to conform to any specific structured interface for interacting with GenAI models. However, the Prompt reference implementation in [Firebase Genkit](https://github.com/firebase/genkit) leverages a common model interface that may be useful for other implementors to follow.

In the future, a Prompt "spec test" will be made available that exercises the various parts of Prompt and compares the results to this common model request format.
...
This interface provides a flexible and powerful way to interact with GenAI models, supporting various types of inputs, outputs, and model configurations.`,i={title:"Common Model Interface",author:"Firebase",sort_order:4,draft:!1,tags:[],hide_breadcrumbs:!1,hide_toc:!1,hide_sidenav:!1,max_width:!1},r={type:"content",filePath:"/workspaces/.prompt/docs/src/content/docs/reference/model.mdx",rawData:void 0};export{r as _internal,o as body,n as collection,i as data,e as id,t as slug};
