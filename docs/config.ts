...
export const SITE = {
  website: "https://neopilot-ai.github.io/.prompt", // replace this with your deployed domain
  author: "Firebase",
  desc: "Prompt: The executable GenAI prompt format.",
  title: "Prompt",
  ogImage: "og-image.jpg",
  repo: "https://github.com/neopilot-ai/.prompt",
};
